...
public class TextureCreatorWindow : EditorWindow {
    ...
    void OnGUI()
    {
        ...
        if (GUILayout.Button("Save", GUILayout.Width(wSize)))
        {
            ...
            System.IO.Directory.CreateDirectory(Application.dataPath + "/Materials/Textures");
            File.WriteAllBytes(Application.dataPath + "/Materials/Textures" + filename + ".png", bytes);
        }
        GUILayout.FlexibleSpace();
        GUILayout.EndHorizontal();
    }
